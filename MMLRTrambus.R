...
#400m radius catchment
Melb.Trambus.400.noFTZ<- MMLR_Data[ which(MMLR_Data$Type=='Trambus'
                                          & MMLR_Data$Radius=='400'
                                          & MMLR_Data$Set_Sample_ID == 'C'
                                          & MMLR_Data$X19_FTZ=='0'),]
Trambus_fs_400 <- factor.scores(fa.data.Melb.Trambus.400.noFTZ, fa.Melb.Trambus.400.noFTZ.varimax)
Trambus_fs_400 <- Trambus_fs_400$scores         #get the columns of factor scores for each case
Melb.Trambus.400.noFTZ<- cbind(Melb.Trambus.400.noFTZ,Trambus_fs_400)
fa.Melb.Trambus.400.noFTZ.varimax
...
#400m
Melb.Trambus.400.noFTZ.VIF<-vif(lm(ln_Tram ~ X7_PropComm+X9_Balance+X10_Entropy+X13_PBN+X17_ACCount+X18_ACNear+X20_LOS+X21_PropFTE+X22_MedInc+X23_MeanSize+X24_Urban+Factor1+Factor2+Factor3, data =Melb.Trambus.400.noFTZ))
Melb.Trambus.400.noFTZ.VIF
#no multicolinearity. Can retain PropFTE
...
#400m
Corrdata.Trambus.400<-Melb.Trambus.600.noFTZ[,c(45, 46,24, 26, 27, 30, 34, 35, 37:41, 48:50)]
#Option 1 for Correlation matrices with p-values
Corrdata.Trambus.400<-rcorr(as.matrix(Corrdata.Trambus.400))

#option 2 for flat correlation matrix
FlatCor.Trambus.400<-flattenCorrMatrix(Corrdata.Trambus.400$r,Corrdata.Trambus.400$P)
capture.output(FlatCor.Trambus.400,file="FlatCor.Trambus.400.csv")
...
#400m
Melb.Trambus.400.MMLR1 <- lm(cbind(ln_Tram, ln_Bus) ~ X7_PropComm+X9_Balance+X10_Entropy+X13_PBN+X17_ACCount+X18_ACNear+X20_LOS+X21_PropFTE+X22_MedInc+X23_MeanSize+X24_Urban+Factor1+Factor2+Factor3, data = Melb.Trambus.400.noFTZ)
summary(Melb.Trambus.400.MMLR1)
Anova(Melb.Trambus.400.MMLR1)

#remove X24_Urban
Melb.Trambus.400.MMLR2 <- lm(cbind(ln_Tram, ln_Bus) ~ X7_PropComm+X9_Balance+X10_Entropy+X13_PBN+X17_ACCount+X18_ACNear+X20_LOS+X21_PropFTE+X22_MedInc+X23_MeanSize+Factor1+Factor2+Factor3, data = Melb.Trambus.400.noFTZ)
summary(Melb.Trambus.400.MMLR2)
Anova(Melb.Trambus.400.MMLR2)

#remove Mean_Size
Melb.Trambus.400.MMLR3 <- lm(cbind(ln_Tram, ln_Bus) ~ X7_PropComm+X9_Balance+X10_Entropy+X13_PBN+X17_ACCount+X18_ACNear+X20_LOS+X21_PropFTE+X22_MedInc+Factor1+Factor2+Factor3, data = Melb.Trambus.400.noFTZ)
summary(Melb.Trambus.400.MMLR3)
Anova(Melb.Trambus.400.MMLR3)

#remove PropFTE
Melb.Trambus.400.MMLR4 <- lm(cbind(ln_Tram, ln_Bus) ~ X7_PropComm+X9_Balance+X10_Entropy+X13_PBN+X17_ACCount+X18_ACNear+X20_LOS+X22_MedInc+Factor1+Factor2+Factor3, data = Melb.Trambus.400.noFTZ)
summary(Melb.Trambus.400.MMLR4)
Anova(Melb.Trambus.400.MMLR4)

#remove MedInc
Melb.Trambus.400.MMLR5 <- lm(cbind(ln_Tram, ln_Bus) ~ X7_PropComm+X9_Balance+X10_Entropy+X13_PBN+X17_ACCount+X18_ACNear+X20_LOS+Factor1+Factor2+Factor3, data = Melb.Trambus.400.noFTZ)
summary(Melb.Trambus.400.MMLR5)
Anova(Melb.Trambus.400.MMLR5)

capture.output(summary(Melb.Trambus.400.MMLR5), file = "Melb.Trambus.400.MMLR5.csv")
...
#400m
plot(lm(ln_Tram ~ X7_PropComm+X9_Balance+X10_Entropy+X13_PBN+X17_ACCount+X18_ACNear+X20_LOS+Factor1+Factor2+Factor3, data = Melb.Trambus.400.noFTZ))
#influential outliers: 286-400-C; 454-400-C; 295-400-C
which(rownames(Melb.Trambus.400.noFTZ) == "286-400-C") #38
which(rownames(Melb.Trambus.400.noFTZ) == "454-400-C") #339
which(rownames(Melb.Trambus.400.noFTZ) == "295-400-C") #120

#remove influential outlier
Melb.Trambus.400.noFTZ.rd2 <- Melb.Trambus.400.noFTZ[-c(38, 339, 120),]
...
#400m
#remove outlier per previous iterations
which(rownames(Melb.Trambus.400.noFTZ.rd2) == "413-400-C") #311
which(rownames(Melb.Trambus.400.noFTZ.rd2) == "352-400-C") #7
which(rownames(Melb.Trambus.400.noFTZ.rd2) == "343-400-C") #170
which(rownames(Melb.Trambus.400.noFTZ.rd2) == "328-400-C") #9
which(rownames(Melb.Trambus.400.noFTZ.rd2) == "525-400-C") #176
which(rownames(Melb.Trambus.400.noFTZ.rd2) == "325-400-C") #5
which(rownames(Melb.Trambus.400.noFTZ.rd2) == "345-400-C") #2
which(rownames(Melb.Trambus.400.noFTZ.rd2) == "197-400-C") #135

Melb.Trambus.400.noFTZ.rd3 <- Melb.Trambus.400.noFTZ.rd2[-c(311, 7, 170, 9, 176, 5, 2, 135),]

Melb.Trambus.400.MMLR.rd3<- lm(cbind(ln_Tram, ln_Bus) ~X7_PropComm+X9_Balance+X10_Entropy+X13_PBN+X20_LOS+Factor1+Factor2+Factor3, data = Melb.Trambus.400.noFTZ.rd3)
summary(Melb.Trambus.400.MMLR.rd3)
Anova(Melb.Trambus.400.MMLR.rd3)
summary(Melb.Trambus.400.MMLR.rd3)
summary(Melb.Trambus.600.MMLR.rd5)

plot(lm(ln_Bus ~ X7_PropComm+X9_Balance+X10_Entropy+X13_PBN+X20_LOS+Factor1+Factor2+Factor3, data = Melb.Trambus.400.noFTZ.rd3))
